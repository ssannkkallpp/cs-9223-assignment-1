...
from rekor_log_verifier.main import (
    get_log_entry,
    inclusion,
...
class TestGetLogEntry:
    ...
    def test_get_log_entry_success(self):
        ...
        with patch(
            "rekor_log_verifier.main.REKOR_CLIENT.log.entries.get",
...
class TestInclusion:
    ...
    def test_inclusion_no_signature_content(self):
        ...
        try:
            ...
            with patch(
                "rekor_log_verifier.main.get_log_entry", return_value=mock_entry
            ):
    ...
    def test_inclusion_no_inclusion_proof(self):
        ...
        try:
            ...
            body_data = {
                "spec": {
                    "signature": {
                        ...
                        "publicKey": {
                            "content": base64.b64encode(b"validcert").decode()
                        },
                    }
                }
            }
            ...
            with patch(
                ...
                with patch(
                    "rekor_log_verifier.main.extract_public_key",
                    return_value=b"mock_public_key",
                ):
                    with patch(
                        "rekor_log_verifier.main.verify_artifact_signature",
                        return_value=True,
                    ):
                        result = inclusion(12345, temp_file, debug=True)
                        assert result is False
...
class TestGetLatestCheckpoint:
    ...
    def test_get_latest_checkpoint_success(self):
        ...
        with patch(
            "rekor_log_verifier.main.REKOR_CLIENT.session.get",
...
class TestConsistency:
    ...
    def test_consistency_missing_tree_id(self):
        ...
        invalid_checkpoint = {"treeSize": 500, "rootHash": "abcd1234"}
    ...
    def test_consistency_latest_checkpoint_none(self):
        ...
        valid_checkpoint = {"treeID": "123", "treeSize": 100, "rootHash": "abc"}
    ...
    def test_consistency_verification_success(self):
        ...
        with patch(
            "rekor_log_verifier.main.get_latest_checkpoint",
